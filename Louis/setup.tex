...
\begin{frame}{Architecture du modèle Autoencodeur}
    ...
    \textbf{loss}: annoncée dans l'article\\
    \textit{loss}: déduite
\end{frame}
...
\subsection{Modèle de fusion}
\begin{frame}{Modèle de fusion}
    \vspace*{\fill}
       \begin{figure}
            \centering
            \only<1>{\includegraphics[width=0.8\textwidth]{img/tr1.png}}%
            \only<2>{\includegraphics[width=0.8\textwidth]{img/tr2.png}}%
            \only<3>{\includegraphics[width=0.8\textwidth]{img/tr3.png}}%
            \only<4>{\includegraphics[width=0.8\textwidth]{img/tr4.png}}%
            \only<5>{\includegraphics[width=0.8\textwidth]{img/tr5.png}}%
            \only<6>{\includegraphics[width=0.8\textwidth]{img/tr6.png}}%
        \end{figure}
        \vspace*{\fill}
        \begin{block}<6->{Type de fusion}
            \centering
            Fusion itérative $\longrightarrow$ combattre la non-IID des données (\textit{FedAvg})
        \end{block}
\end{frame}
